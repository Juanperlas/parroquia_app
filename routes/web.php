...
use App\Http\Controllers\RegistroBautizoController;
...
Route::get('/registros/{numero_registro}/constancia', [RegistroBautizoController::class, 'constancia']);
Route::get('/registros/buscar-constancia', [RegistroBautizoController::class, 'buscarConstancia']);

Route::get('/registros/reportes', [RegistroBautizoController::class, 'reporte'])->name('registros.reporte');
Route::resource('/registros', RegistroBautizoController::class);
