    ...
    <div class="w-full h-full">
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    <li>
                        <SidebarLink href="/dashboard" :active="false">
                            ...
                            <span class="-mr-1 font-medium">Comentarios</span>
                        </SidebarLink>
                    </li>
                    <li>
                        <SidebarLink
                    ...
                    <li>
                        <SidebarLink
                            ...
                            :active="route().current('registros.create')"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                    ...
                    <li>
                        ...
                        >
                            ...
                            <span class="-mr-1 font-medium">Registros</span>
                        </SidebarLink>
                    </li>
                    <li>
                        <SidebarLink
                            :href="route('registros.reporte')"
                            :active="route().current('registros.reporte')"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                            ...
                            <span class="-mr-1 font-medium">Reportes</span>
                        </SidebarLink>
                    </li>
                </ul>
            </div>
        ...
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
                <div
                    class="px-6 flex items-center justify-center space-x-4 2xl:container align-middle"
                >
                    <h5
                        hidden
                        class="text-2xl text-gray-600 font-extrabold lg:block text-center"
                    >
                        SISTEMA - PARROQUIA
                    </h5>
