        ...
        <transition leave-active-class="duration-100">
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            class="absolute inset-0 bg-gray-300 dark:bg-gray-500 opacity-75"
                        />
                    </div>
                </transition>
                ...
                <transition
                    ...
                    enter-to-class="opacity-600 translate-y-0 sm:scale-100"
                    leave-active-class="ease-in duration-200"
                    leave-from-class="opacity-600 translate-y-0 sm:scale-100"
